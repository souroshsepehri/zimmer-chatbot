#!/usr/bin/env python3
"""
Fixed startup script that serves both backend and frontend
"""
import os
import sys
import uvicorn
...
def main():
    ...
    if frontend_out.exists():
        ...
        print("📁 Frontend directory not found at: ../frontend/out")
        @unified_app.get("/")
        async def root():
            return {
                "message": "Persian Chatbot API is running",
                "frontend": "Not available - frontend not built",
                "instructions": "Build frontend locally and commit the 'out' folder",
                "api_docs": "/api/docs",
                "chat_api": "/api/chat"
            }
